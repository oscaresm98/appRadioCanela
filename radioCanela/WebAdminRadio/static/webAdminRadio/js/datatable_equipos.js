$('#data_table').DataTable({
    ...
    columnDefs: [
        ...
        { width: 200, className: "text-center", targets: 5, render: function(data){
            return `<a href="/equipos/` + data + `" class="btn btn-primary btn-sm" role="button"><i class="fas fa-eye"></i></a>
                    <a href="/equipos/` + data + `/editar" class="btn btn-success btn-sm" role="button"><i class="fas fa-pen"></i></a>
